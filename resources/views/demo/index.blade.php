...
<body id="top" >
    ...
    <section class="blog-intro section-padding" id="demo">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h3>Powerful &amp; Beautiful Bootsrtap4 Admin Dashboard</h3>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <h4>Regular User</h4>                    
                    <div class="demo-img"><a href="{{route('demouser')}}" target="_blank" ><img alt="" src="{{asset('assets/images/thumb1.jpg')}}" class="img-responsive"></a></div>
                    <div class="demo-links">
                        <a href="{{route('demouser')}}" target="_blank" class="btn btn-fill btn-large btn-margin-right">Demo</a>
                    </div>
                </div>
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <h4>Admin User</h4>                    
                    <div class="demo-img"><a href="https://admin.bitmetical.com/demo/admin" target="_blank" ><img alt=""  src="{{asset('assets/images/thumb2.jpg')}}" class="img-responsive"></a></div>
                    <div class="demo-links">
                        <a href="https://admin.bitmetical.com/demo/admin" target="_blank" class="btn btn-fill btn-large btn-margin-right">Demo</a>
                    </div>
                </div>
            </div>
        </div>
