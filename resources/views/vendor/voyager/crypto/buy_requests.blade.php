...
@section('page_header')
    ...
    <div class="container-fluid">
        ...
        <h1 class="page-title">
            ...
            <i class="voyager-person"></i> Buy Requests
                                    ...
                                    <tr>
                                       ...
                                       @if($type == 'pending_requests')
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:void(0)" class="btn btn-xs {{ ($row->status == 0) ? 'btn-danger' : 'btn-success' }} ml-1 statusBtn" data-original-title="@lang('Status')" data-toggle="tooltip" data-url="{{route('admin.update_buy_crypto_status',$row->id)}}">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div style="display:none" class="form-group preuve">

                                <label for="preuve">Capture de la transaction</label>

                                <input type="file" name="preuve" id="preuve" accept=".png, .jpeg, .jpeg, .webp, .gif">
...
<script type="text/javascript">
    ...
    document.addEventListener('DOMContentLoaded',function(){
        ...
        $('.status').on('change', function () {
            ...
            let preuve=document.querySelector(".preuve")

            let stat_val=stat.options[stat.selectedIndex].value;
