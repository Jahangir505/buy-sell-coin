...
{{--	@include('partials.nav')	--}}
    <div class="row">
        ...
        <div class="col-md-9 ">
		    ...
		    <div class="body">
		        <form action="{{route('generateVoucher')}}" method="POST" id="voucher_form">
                			{{csrf_field()}}
		                	<div class="row">
		...
		<div class="card">
			...
			<div class="card">
			    ...
			    <div class="body">
		           <form action="{{route('load_my_voucher')}}" method="POST" id="voucher_form">
            			{{csrf_field()}}
	                	<div class="row">
                			<div class="col">
                				<div class="form-group {{ $errors->has('balance_amount') ? ' has-error' : '' }}">
			...
			<div class="card bg-light">
			    ...
			    <div class="body">
		           <form action="{{route('load_voucher_to_user')}}" method="POST" id="voucher_form">
            			{{csrf_field()}}
	                	<div class="row">
                			<div class="col">
