                ...
                <div class="menu">
                    <ul class="list">
                        ...
                        <li class="{{ (Route::is('home') ? 'active open' : '') }}"> 
                            <a href="{{ route('home') }}"><i class=" icon-layers"></i><span>{{__('Transactions')}}</span></a>
                        </li>
                        {{--
                        <li class="{{ (Route::is('exchange.form') ? 'active open' : '') }}"> 
                            <a href="{{url('/')}}/exchange/first/0/second/0"><i class="icon-refresh"></i><span>{{__('Exchange')}}</span></a>
                        </li>
                        --}}
                        ...
                        <li class="{{ (Route::is('escrow') ? 'active open' : '') }}"> 
                            <a href="{{route('escrow')}}"><i class="icon-arrow-right"></i><span>{{__('Escrow')}}</span></a>
                        </li>
                        ...
                        <li class="{{ (Route::is('mydeposits') ? 'active open' : '') }}"> 
                            <a href="{{route('mydeposits')}}"><i class="icon-arrow-down"></i><span>
                            {{__('My Deposits')}}</span></a>
                        </li>
                        <li class="{{ (Route::is('withdrawal.index') ? 'active open' : '') }}"> 
                            <a href="{{route('withdrawal.index')}}"><i class="icon-arrow-up"></i><span>
