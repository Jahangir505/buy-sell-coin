            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="company_detail">
                        ...
                        <h3>{{__("Verify your new account")}}</h3>
                ...
                <div class="col-lg-5 col-md-12 offset-lg-1">
                    ...
                    <form class="form" action="{{url('/')}}/otp" method="post">    
                    ...
                    <div class="card-plain">
                        ...
                        <div class="header">
                            ...
                            <h5 class="mb-5">{{__("One Time Password")}}</h5>

                            <span>{{__("To verify your account, we've sent a One Time Password to (OTP) to the email")}} {{ Auth::user()-> email }}  </span>
                        ...
                        <div class="footer">
                            ...
                            <input type="submit" class="btn btn-primary btn-round btn-block" value="{{__('SUBMIT')}}" >                            

                        </div>

                        <a href="javascript:void(0);" class="link">{{__("Resend OTP")}}</a>
