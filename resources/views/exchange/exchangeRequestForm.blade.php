                    ...
                    <div class="body">
                         {{csrf_field()}}
                            ...
                            <div class="col">
                                  ...
                                  <div class="nav-item dropdown">
                                      ...
                                      <div class="dropdown-menu" aria-labelledby="CurrencyNavbarDropdown">
                                        ...
                                        <a class="dropdown-item" href="{{url('/')}}/wallet/{{$currency->firstCurrency->id}}"> 
                          ...
                          <div class="row">
                            <div class="col">
                              <div class="form-group {{ $errors->has('amount') ? ' has-error' : '' }}">
                                 <label for="amount"><h2 class=" mb-0 mt-0"><span>+</span>@{{total}}<small>{{$secondCurrency->symbol}}</small></h2></label>
                              </div>
                            </div>
                          </div>
                          <div class="row">
