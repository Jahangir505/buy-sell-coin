...
<html lang="en">
    ...
    <form  class="crypto-form confirm_form" id="<?echo $want."_crypto"?>" <?if($want=="buy"){?> action="{{route('postBuyCrypto')}}" <?} if($want=="sell"){?> action="{{route('postSellCrypto')}}" <?}?> method="post" enctype="multipart/form-data">
                                            ...
                                            <select class="form-control select_coin" name="coin_id" required="">
                                                ...
                                                @foreach($coin_data as $key=>$value)
                                                    ...
                                                    <?php if($value->id==$data->coin_id){
                                                        $selected_coin_name=$value->coin_name;
                                                    ?>
