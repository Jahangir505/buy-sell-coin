...
<h2 class="head-title"><br class="d-none d-xl-block">{{ __("Buy and sell your BTC, USDT and other virtual currencies at the best price with Pros traders") }}</h2>

<p>{{ __("Buy and sell your BTC or USDT securely, wherever you are and whenever you want; We are a team of professionals in buying and selling popular cryptocurrencies and digital currencies (BTC, USDT, Payeer, Perfect Money, Paypal and much more). Satisfaction guaranteed") }}
...
@if(!Auth::check())
  ...
  <a href="/register" rel="nofollow" class="btn btn-border-filled">{{ __("Register") }}</a>

@else
  <a href="/home" rel="nofollow" class="btn btn-border-filled">{{ __("Dashboard") }}</a>
@endif

<a href="/about" class="btn btn-border page-scroll">{{ __("Documentation") }}</a>
...
<div class="image text-center">
  <img src="https://probuysellcoin.com/assets/front/img/exchange.png" class="rounded" alt="BUY SELL COIN">
      ...
      <h3>{{ __("Start a transaction with the Pros traders and experience the difference") }} </h3>
      
      <p>{{ __("Don't run the risk of being scammed online when buying or selling your cryptos! With us, don't worry. Fast, secure and low-cost transactions") }}.</p>
...
<div class="row justify-content-md-center">
      ...
      @if($admin_online[0]->status=="10")
            ...
            <div class="header">
              ...
              <div class="onlineIco isOnline row">
                ...
                <div class="col description">
                    ...
                    <span class="detail">{{__("Below are our service times")}}<br> <span >{{__("Monday - Saturday: 8a.m - 10p.m")}} <br> {{__("Sunday: 12p.m - 8p.m")}} </span><br>
        ...
        <div style="display:flex; background-color:rgb(245,245,245); font-seize:18px; width:100%; user-select:none;"  class="crypto-form-menu form-element">
          ...
          <p id="buy-menu-item" style="width:100%; text-align:center; padding:19px; background-color:white; border:1px solid rgb(240,240,240);">{{ __("Buy") }}</p>
          <p id="sell-menu-item" style="width:100%; text-align:center; padding:19px;">{{ __("Sell") }}</p>
        ...
        <div class="body">
                  ...
                  <form class="crypto-form" id="buy_crypto" action="{{route('postBuyCryptoConfirm')}}" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                ...
                                <select {{$disable}} class="form-control select_coin" name="coin_id" required="">
                                  ...
                                  @foreach($coins as $key=>$value)
                                    ...
                                    <option data-wallet_address="{{$value->wallet_adress}}" data-price="{{$value->sell_price}}" value="{{$value->id}}">{{$value->coin_name}}</option>
                         ...
                         <div class="row">
                            ...
                            <div class="col-lg-6  col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                  ...
                                  <label {{$disable}} for="deposit_method">{{ __("Amount (USD)") }}</label>
                            ...
                            <div class="col-lg-6  col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                  ...
                                  <label for="deposit_method">{{ __("Amount of crypto to buy") }}</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                  ...
                                  <label id="data_user_adresse" data-user-adresse="{{json_encode($custom_method)}}" for="deposit_method">{{ __("Crypto wallet address") }}</label>
                                  ...
                                  <input {{$disable}} id="buy_pay_address" type="hidden" name="wallet_address">

                                  <input {{$disable}} type="hidden" value="1" name="custom_method" id="custom_method">
                                  ...
                                  <div class="modal-dialog modal-dialog-centered" role="document">
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="mb-3">
                                        ...
                                        <select {{$disable}} name="nom" class="form-control" id="nom">
                    ...
                    @if($disable=="disabled")
                      ...
                      <p {{$disable}} data-toggle="modal" data-target="#offlinemodal" type="submit" class="btn btn-common submit_form" id="submit" style="color:white;">{{__('Submit')}}</p>

                    @else

                      <button  type="submit" class="btn btn-common submit_form" id="submit">{{__('Submit')}}</button>
        ...
        <div class="body">
                  ...
                  <form class="crypto-form" id="sell_crypto" action="{{route('postSellCryptoConfirm')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                  ...
                                  <label for="deposit_method">{{ __("Amount of crypto to sell") }}</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                  ...
                                  <label for="deposit_method"><span class="crypto_name"></span> {{ __("Crypto wallet address") }}</label>
        
                                  <input {{$disable}} style="height:max-content;" type="text" value="" readonly="" class="form-control wallet_address" required="" name="wallet_address">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                              ...
                              <div class="form-group">
                                ...
                                <label for="pay_method">{{ __("Payment method") }}</label>
                        ...
                        <div class="clearfix"></div>
                        <div class="text-center">
                        <br><br><button {{$disable}} class="btn btn-common submit_form" id="submit" type="submit">{{ __("Submit") }}</button></div>
                  </form>
...
<div class="container list-info" >
  ...
  <img src="https://probuysellcoin.com/assets/front/img/shop.png" class="rounded" alt="BUY SELL COIN">
      ...
      <p class="section-title" style="font-weight:450; color:black; font-size:22px;">{{ __("What you can buy or sell") }}</p>
  ...
  <img src="https://probuysellcoin.com/assets/front/img/money-bag.png" class="rounded" alt="BUY SELL COIN">
      ...
      <p class="section-title" style="font-weight:450; color:black; font-size:22px;">{{ __("Payment methods accepted") }}</p>
  ...
  <img src="https://probuysellcoin.com/assets/front/img/worldwide.png" class="rounded" alt="BUY SELL COIN">
      ...
      <p class="section-title" style="font-weight:450; color:black; font-size:22px;">{{ __("Countries concerned") }}</p>
...
<h3>{{ __("Receive your Bitcoins or USDT directly in your wallet") }} </h3>

<p>{{ __("Buy your BTC or USDT with the payment method that suits you best you prefer (MTN Money, Orange Money, Touch UV, Solde balance, RAGP XAF or XOF, bank transfer, etc.) and receive the funds directly into the wallet of your choice as soon as you you make the payment. Transaction fees are at our expense") }}.</p>

<a class="btn btn-common" href="#">{{ __("STARTING") }}</a>
...
<h2 style="line-height:46px;" class="section-title">{{ __("The advantages of choosing us as your transaction partner") }}</h2>

<div class="desc-text">

<p>{{ __("Whether you are in Cameroon, Gabon, Central African Republic, Burkina Faso, Ivory Coast, Senegal or any other country in the XOF or XAF zone, there are many advantages to choosing us as your transaction partner") }}</p>
...
<h4>{{ __("We are reliable") }}</h4>

<p>{{ __("We have a proven reputation for being the best. the best. See testimonials") }}</p>
...
<h4>{{ __("We are fast") }}</h4>

<p>{{ __("As soon as you initiate a transaction, we finalise it as quickly as possible") }}</p>
...
<h4>{{ __("The customer is the KING") }}</h4>

<p>{{ __("Every transaction is a pleasure and the satisfaction of our customers is a priority") }}</p>
...
<h4>{{ __("Simplified purchasing procedures") }}</h4>

<p>{{ __("When you buy, we send your cryptos directly to your wallet") }}</p>
...
<h4>{{ __("Simplified sales procedure") }}</h4>

<p>{{ __("Send your cryptos directly to our Wallet, and receive your money quickly via the payment method of your choice of your choice") }}</p>
...
<h4>{{ __("Limit the hassle") }}</h4>

<p>{{ __("There's no need to put up with the hassle of platforms imposing lengthy lengthy procedures! We make it simple with us") }}</p>
  ...
  <div class="container">
    ...
    <div class="col-lg-6 col-md-12 pl-0 pr-5">
      ...
      <div class="business-item-info">
        ...
        <h3>{{ __("Our generous affiliate program") }} </h3>
        <p>{{ __("Earn extra income with our generous affiliate program. With Pro Buy Sell Coin, every transaction made by your affiliates will earn you money for life.") }} </p>
        
        <h4>{{ __("How does it work in practice?") }}</h4>
    
    <div class="desc-text">
        <ul>
          <li>{{ __("Sign up for free to get your affiliate link") }}</li>
          <li>{{ __("Share this link with your friends or on your different social media platforms (Facebook, WhatsApp, Twitter, ...)") }}</li>
          <li>{{ __("Each person who registers by clicking on your link automatically becomes your affiliate.") }}</li>
          <li>{{ __("With each successful purchase or sale transaction made by your affiliate, you will automatically receive 0.4% of the transaction amount, in perpetuity!") }}</li>
          <li>{{ __("You can withdraw your winnings whenever you want and you will receive your money via the payment method of your choice.") }}</li>
        </ul>
    
    </div>
    
    <p><a class="color-blue" href="/register">{{ __("Register")}} </a>{{ __("now and start a new adventure with us.") }}</p><br>
...
@if($disable=="disabled" && Auth::check())
