...
<?php elseif(@$transaction->activity_title == 'Deposit'): ?>
	<?php echo e(@$transaction->activity_title); ?> <br><a href="#"><?php echo e(__('From')); ?> <?php echo e(@$transaction->entity_name); ?></a>
<?php elseif(@$transaction->activity_title == 'Gift Card'): ?>
	<?php echo e(@$transaction->activity_title); ?> <br><a href="#"><?php echo e(__('From')); ?> <?php echo e(@$transaction->entity_name); ?></a>
<?php elseif(@$transaction->activity_title == 'Buy Crypto'): ?>
	<?php echo e(@$transaction->activity_title); ?> <br><a href="#"><?php echo e(__('From')); ?> <?php echo e(@$transaction->entity_name); ?></a>
<?php elseif(@$transaction->activity_title == 'Sell Crypto'): ?>
	<?php echo e(@$transaction->activity_title); ?> <br><a href="#"><?php echo e(__('From')); ?> <?php echo e(@$transaction->entity_name); ?></a>
...
<?php elseif(@$transaction->activity_title == 'Payzoft Card fund'): ?>
	<?php echo e(@$transaction->activity_title); ?> <br><a href="#"><?php echo e(__('In')); ?> <?php echo e(@$transaction->entity_name); ?> </a>
	<?php elseif(@$transaction->activity_title == 'Payzoft Card Creation'): ?>
	<?php echo e(@$transaction->activity_title); ?> <br><a href="#"><?php echo e(__('In')); ?> <?php echo e(@$transaction->entity_name); ?> </a>
