<footer id="home-footer">
    <div class="container texte-white">
        ...
        <?$lang="fr"; if(session()->has("lang")){(session()->get("lang")=="fr")?$lang="en":$lang="fr";}?>

        <a style="text-align:center; color:white" href="lang/<?php echo e($lang); ?>" id="lang"><img style="heigh:30px; width:30px; " src="/assets/front/img/<?echo $lang.".png";?>"  alt="lang"><?php echo e(ucfirst(str_replace(["fr","en"],["Francais","English"],$lang))); ?></a>
