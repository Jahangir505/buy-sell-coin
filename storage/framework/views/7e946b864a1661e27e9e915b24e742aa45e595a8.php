                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group" style="margin-bottom: 0 !important;" >
                              ...
                              <div class="input-group" id="buy_custom_paiemen" style="display: flex; align-items:center;margin-bottom: 0 !important;">
                                <select <?php echo e($disable); ?> class=" input-group-text form-control" name="wallet_address"  style="z-index: 999; position: relative; background: transparent; margin-right: 15px; border: 1px solid #E9F6EC;">
