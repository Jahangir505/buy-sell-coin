...
<h3 class="block-title"><?php echo e(__('About')); ?></h3>

<ul class="menu">

<li><a href="#"> - <?php echo e(__('Who we are')); ?></a></li>

<li><a href="#">- <?php echo e(__('Our team')); ?></a></li>

<li><a href="#">- <?php echo e(__('Testimonies')); ?></a></li>
...
<div class="widget">
    ...
    <h3 class="block-title"><?php echo e(__('Our service')); ?></h3>

    <ul class="menu">

    <li><a href="#"> - <?php echo e(__('Sell crypto')); ?></a></li>

    <li><a href="#">- <?php echo e(__('Buy crypto')); ?></a></li>

    <li><a href="#">- <?php echo e(__('Sending money')); ?></a></li>
...
<div class="widget">
    ...
    <h3 class="block-title"><?php echo e(__('Useful links')); ?></h3>

    <ul class="menu">

    <li><a href="#"> - <?php echo e(__('How does it work')); ?></a></li>

    <li><a href="#">- <?php echo e(__('Accepted country')); ?></a></li>

    <li><a href="#">- <?php echo e(__('Payment methods')); ?></a></li>
...
<h3 class="block-title"><?php echo e(__('Download App')); ?></h3>
...
<table class="menu dowload_app">
    ...
    <tr><td> 
        ...
        <a class="row" style="width:max-content" href="lang/<?php echo e(@$lang); ?>" id="lang"><img style="heigh:30px; width:30px;" src="/assets/front/img/<?echo @$lang.".png";?>"  alt="lang"><span style="margin-top:-5px"><?php echo e(ucfirst(str_replace(["fr","en"],["Francais","English"],@$lang))); ?></span></a>
