                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group">
                          ...
                          <label for="deposit_method"><?php echo e(__("Amount of currency to sell")); ?></label>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group">
                          ...
                          <label for="deposit_method"><span class="crypto_name"></span> <?php echo e(__("wallet address")); ?></label>
