...
for (var i = 0; i < chats.length; i++) {
  ...
  $.chatCtrl('#mychatbox', {
    ...
    picture: (chats[i].position == 'left' ? '../../../../../templates/logicswave/jiva/source/light/assets/img/users/user-5.png' : '../../../../../templates/logicswave/jiva/source/light/assets/img/users/user-1.png'),
...
$("#chat-form").submit(function () {
  ...
  if (me.find('input').val().trim().length > 0) {
    $.chatCtrl('#mychatbox', {
      ...
      picture: '../../../../../templates/logicswave/jiva/source/light/assets/img/users/user-5.png',
    });
    me.find('input').val('');
  }
  return false;
